...
const IndeterminateCheckbox = ((props) => {
    ...
    const handleChange = (e) => {
        console.log(e , "checking the tabel ")
        onChange(e)
        onCheckBoxChange?.(e)
...
const DataTable = forwardRef((props, ref) => {
   ...
   <Loading loading={loading && data?.length !== 0} type="cover">
                                    ...
                                    >
                                        {header.isPlaceholder ? null : (
                                            <div
                                                className={
                                                    classNames(
                                                        header.column.getCanSort() && 'cursor-pointer select-none point whitespace-nowrap',
        ...
        <div className="flex items-center justify-between mt-4">
            <Pagination
                pageSize={pageSize}
                currentPage={pageIndex || pageNumber}
                total={total}
