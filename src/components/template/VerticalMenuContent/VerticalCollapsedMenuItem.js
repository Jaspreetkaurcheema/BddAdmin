            ...
            >
                {nav.subMenu.map((subNav) => (
                    <AuthorityCheck
                        ...
                        key={subNav.key}
                    >
                        <MenuItem eventKey={subNav.key} disabled={subNav.title  == "Dashboard" ? true:false } >
                            {subNav.path ? (
                                <Link
                                    ...
                                    onClick={() =>
                                      ...
                                      to={subNav.title  != "Dashboard"? subNav.path:"#"}
                                >
                                    <span>
                                        <Trans
