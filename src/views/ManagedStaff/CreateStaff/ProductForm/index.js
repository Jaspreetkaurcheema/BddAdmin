...
const validationSchema = Yup.object().shape({
    ...
    email : Yup.string().required('email Required') .matches(/\.com|tech|in$/, 'Email must end with .com, .tech and .in'),
    password : Yup.string().required('password Required') .matches(/[a-zA-Z]/, 'Password must contain at least one alphabet character')
