...
const DeletePaymentMethod = () => {
    ...
    const data = useSelector(
        (state) => state.poolEventDetails.data.paymentMethodData
    )
    const dialogOpen = useSelector(
        (state) => state.poolEventDetails.state.deletePaymentMethodDialog
    )
    const selectedCard = useSelector(
        (state) => state.poolEventDetails.state.selectedCard
    )
