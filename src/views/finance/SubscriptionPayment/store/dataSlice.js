...
export const getCustomers = createAsyncThunk(
    'crmSubscriptionPayment/data/getCustomers',
    async (params) => {
        const response = await apiGetSubscriptionPayment(params)
        return response.data
    }
)

export const putCustomer = createAsyncThunk(
    'crmSubscriptionPayment/data/putCustomer',
    async (data) => {
...
const dataSlice = createSlice({
    name: 'apiGetSubscriptionPayment/data',
    initialState: {
        loading: false,
        customerList: [],
        statisticData: {},
