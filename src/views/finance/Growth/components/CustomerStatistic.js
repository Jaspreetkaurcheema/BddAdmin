...
const CustomerStatistic = () => {
    ...
    const data = useSelector((state) => state.financeGrowth.data.customerList.
    total_donations
    )
    const loading = useSelector(
        (state) => state.financeGrowth.data.statisticLoading
    )
...
console.log(data,'statisticDatastatisticData')
    return (
