...
const validationSchema = Yup.object().shape({
    subscription_id: Yup.string().required(' Subscription ID Required'),
    trial_period: Yup.string().required(' Trail Period Required'),
    offer_type: Yup.string().required('Offer Type Required'),
    discount_percentage: Yup.string().required(' Discount Percentage Required'),
