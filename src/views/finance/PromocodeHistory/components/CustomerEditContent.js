...
const CustomerEditContent = forwardRef((_, ref) => {
    ...
    const onFormSubmit = (values) => {
        ...
        const basicInfo = { id, coupon_name, coupon_code, coupon_description, coupon_type, coupon_off, max_number_of_usage, max_per_user_usage, min_order_amount, coupon_expiry_date, valid_to_event_id, valid_to_organizer_user_id, updated_by_user_id }
        ...
        dispatch(getCoupons({ pageIndex: 1, pageSize: 10, search: '' }))
    }
