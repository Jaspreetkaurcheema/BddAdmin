...
export const getCustomers = createAsyncThunk(
    'crmSubscription/data/getCustomers',
    async (params) => {
        const response = await apiGetSubscriptionCustomers(params)
        return response.data
    }
)

export const putCustomer = createAsyncThunk(
    'crmSubscription/data/putCustomer',
    async (data) => {
        const response = await apPutSubscriptionCustomer(data)
        return response.data
    }
)
