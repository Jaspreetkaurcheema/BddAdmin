...
import CustomerForm from 'views/cms/Motivational/CustomerForm'
...
const CustomerEditContent = forwardRef((props, ref) => {
    ...
    const data = useSelector((state) => state.crmMotivational.data.customerList)
    const { id } = customer
    ...
    const onFormSubmit = (values) => {
        ...
        const basicInfo = { title, description, url, img }
        const personalInfo = {
            title,
            description,
            url,
