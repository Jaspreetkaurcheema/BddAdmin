...
const Customers = () => {
    const dispatch = useDispatch()
    const data = useSelector((state) => state.crmMotivational.data.customerList.data)
    const [isVisible , setIsVisible] = useState(false)
    const loading = useSelector((state) => state.crmMotivational.data.loading)
    const filterData = useSelector(
        (state) => state.crmMotivational.data.filterData
    )
    const columns = [
        {
                    header: 'Id',
                    ...
                    cell: (props) => {
                        ...
                        return (
                            <div className="flex items-center">
                                ...
                                <span className="ml-2 rtl:mr-2 capitalize">
                              <a href={row.url} target="_blank" rel="noopener noreferrer" style={{ color: '#3b82f6' }}>{row.url}</a>
                ...
                {
                    header: 'Motivational_Video_Created',
                    ...
                    /> : (
                        <div className="h-full flex flex-col items-center justify-center">
                            <DoubleSidedImage
                                ...
                                alt="No user found!"
                            />
                            <h3 className="mt-8">No Motivational Video  found!</h3>
                        </div>
                    )
                }</>} </>
