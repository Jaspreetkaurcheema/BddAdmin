...
import { deleteCategorizedArticles, getCategorizedArticles, setCategorizedArticles } from '../store/dataSlice'
...
const Confirmations = ({ data }) => {
    ...
    const onArticleDeleteConfirm = () => {
        ...
        const removedData = allArticles.filter(
            (categories) => categories.id !== selected.id
        )
        dispatch(deleteCategorizedArticles({ pageId: selected.id, isDelete: true})) 
        dispatch(toggleArticleDeleteConfirmation(false))
