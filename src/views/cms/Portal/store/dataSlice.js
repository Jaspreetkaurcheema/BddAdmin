...
import {
    apiGetCrmCustomers,
    apPutTutorialCustomer,
    apDeleteCrmPortal,
    apiGetCrmCustomersStatistic,
    apiGetTutorialCustomers
...
export const getCustomers = createAsyncThunk(
    'crmPortal/data/getCustomers',
    async (params) => {
        const response = await apiGetTutorialCustomers(params)
        return response.data
    }
)
export const deletePortal = createAsyncThunk(
    'crmPortal/data/putCustomer',
    async (data) => {
        const response = await apDeleteCrmPortal(data)
...
export const putCustomer = createAsyncThunk(
    'crmPortal/data/putCustomer',
    async (data) => {
        const response = await  apPutTutorialCustomer(data)
        return response.data
    }
)
