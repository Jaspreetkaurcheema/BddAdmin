...
import CustomerForm from 'views/Event/Sports/CustomerForm'
...
const CustomerEditContent = forwardRef((props, ref) => {
    ...
    const customer = useSelector(
        (state) => state.crmSports.state.selectedCustomer
    )


    const data = useSelector((state) => state.crmSports.data.customerList)
