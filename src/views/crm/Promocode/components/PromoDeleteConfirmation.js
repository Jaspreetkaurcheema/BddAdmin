...
import { deletePromo, getCustomers } from '../store/dataSlice'
import { toggleDeleteConfirmation } from '../store/stateSlice'
// import { deleteProduct, getProducts } from '../store/dataSlice'

const PromoDeleteConfirmation = () => {
    ...
    const onDelete = async () => {
        dispatch(toggleDeleteConfirmation(false))
        const success = await dispatch(deletePromo({ id: selectedProduct.id, isDelete: true }))
...
export default PromoDeleteConfirmation
