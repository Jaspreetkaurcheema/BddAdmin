...
import { toggleStatusConfirmation } from '../Referee/store/stateSlice'
import OrganizersStatusConfirmation from '../Referee/components/OrganizersStatusConfrmation'
...
const PersonalInfoForm = (props) => {
    ...
    return (
        <>
            ...
            < OrganizersStatusConfirmation status_id={values.enabled}  id={values.id} />
