...
const PlayersStatusConfirmation = ({status_id, isVisible,setIsVisible}) => {

    const [remarks,setRemark]=useState('')
   
    const dispatch = useDispatch()
    const dialogOpen = useSelector(
        (state) => state.crmPlayers?.state?.statusConfirmation
    )
...
export default PlayersStatusConfirmation
