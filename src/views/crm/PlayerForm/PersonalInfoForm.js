...
import { toggleStatusConfirmation } from '../Players/store/stateSlice'
import PlayersStatusConfirmation from '../Players/components/PlayersStatusConfirmation'
...
const PersonalInfoForm = (props) => {
    ...
    return (
        <>
            ...
            < PlayersStatusConfirmation status_id={values.enabled}  id={values.id} />
