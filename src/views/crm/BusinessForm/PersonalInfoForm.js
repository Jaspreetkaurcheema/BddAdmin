...
import { toggleStatusConfirmation } from '../Business/store/stateSlice'
import BusinessStatusConfirmation from '../Business/components/BusinessStatusConfirmation'
...
const PersonalInfoForm = (props) => {
    ...
    return (
        <>
            ...
            < BusinessStatusConfirmation status_id={values.enabled}  id={values.id} />
