...
const TeamMomStatusConfirmation = ({status_id, isVisible,setIsVisible}) => {

    const [remarks,setRemark]=useState('')
   
    const dispatch = useDispatch()
    const dialogOpen = useSelector(
        (state) => state.crmTeamMom?.state?.statusConfirmation
    )
...
export default TeamMomStatusConfirmation
