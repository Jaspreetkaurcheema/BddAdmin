...
import { toggleStatusConfirmation } from '../Coach/store/stateSlice'
import CoachStatusConfirmation from '../Coach/components/CoachStatusConfirmation'
...
const PersonalInfoForm = (props) => {
    ...
    return (
        <>
            ...
            < CoachStatusConfirmation status_id={values.enabled}  id={values.id} />
