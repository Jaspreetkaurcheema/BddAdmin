...
const FamilyDeleteConfirmation = ({isVisible,setIsVisible}) => {
    const dispatch = useDispatch()
    const dialogOpen = useSelector(
        (state) => state.crmFamily.state.deleteConfirmation
    )
...
export default FamilyDeleteConfirmation
