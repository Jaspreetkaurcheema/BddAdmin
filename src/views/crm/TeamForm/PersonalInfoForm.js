...
import { toggleStatusConfirmation } from '../TeamMom/store/stateSlice'
import TeamMomStatusConfirmation from '../TeamMom/components/TeamMomStatusConfirmation'
...
const PersonalInfoForm = (props) => {
    ...
    return (
        <>
            ...
            < TeamMomStatusConfirmation status_id={values.enabled}  id={values.id} />
