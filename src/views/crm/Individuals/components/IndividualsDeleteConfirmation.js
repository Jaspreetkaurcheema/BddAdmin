...
const IndividualsDeleteConfirmation = ({isVisible,setIsVisible}) => {
    const dispatch = useDispatch()
    const dialogOpen = useSelector(
        (state) => state.crmIndividuals.state.deleteConfirmation
    )
        ...
        if (success) {
            ...
            toast.push(
                <Notification
                    ...
                    duration={2500}
                >
                    Individuals successfuly deleted
                </Notification>,
                {
    ...
    return (
        ...
        >
            <p>
                Are you sure you want to delete this Individuals ? This action cannot be
                undone.
            </p>
        </ConfirmDialog>
    )
...
export default IndividualsDeleteConfirmation
