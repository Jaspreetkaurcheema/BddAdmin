...
import { toggleStatusConfirmation } from '../Familys/store/stateSlice'
import FamilyStatusConfirmation from '../Familys/components/FamilyStatusConfirmation'
...
const PersonalInfoForm = (props) => {
    ...
    return (
        <>
            ...
            < FamilyStatusConfirmation status_id={values.enabled}  id={values.id} />
