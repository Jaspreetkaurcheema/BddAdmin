...
const CoachDeleteConfirmation = ({isVisible,setIsVisible}) => {
    const dispatch = useDispatch()
    const dialogOpen = useSelector(
        (state) => state.crmCoach.state.deleteConfirmation
    )
...
export default CoachDeleteConfirmation
