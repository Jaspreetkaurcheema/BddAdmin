...
const EditPaymentMethod = () => {
    ...
    const card = useSelector(
        (state) => state.crmCustomerDetailss.state.selectedCard
    )
    const data = useSelector(
        (state) => state.crmCustomerDetailss.data.paymentMethodData
    )
    const dialogOpen = useSelector(
        (state) => state.crmCustomerDetailss.state.editPaymentMethodDialog
    )
