...
const validationSchema = Yup.object().shape({
    tutorial_video_question: Yup.string().required(' Question Required'),
    tutorial_video_answer: Yup.string().required(' Answer Required'),
    tutorial_video_id: Yup.string().required(' Type Required'),
})
