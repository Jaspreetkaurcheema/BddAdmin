...
const SignUpForm = (props) => {
    ...
    const onSignUp = async (values, setSubmitting) => {
        const { first_name,last_name,middle_name, password, email } = values
        setSubmitting(true)
        const result = await signUp({ first_name,last_name,middle_name, password, email })
